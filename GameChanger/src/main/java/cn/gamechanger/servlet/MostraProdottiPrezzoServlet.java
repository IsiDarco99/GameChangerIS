    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
    	...
    	try {
    	    ...
    	    if(categoria.equals("allProdotti")) {
                ...
                Prodotto prodotti = pd.getProdottoByPrezzo(min, max);
