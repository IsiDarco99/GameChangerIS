...
@WebServlet("/visualizza-all-ordini")
public class VisualTuttiOrdiniServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    
    public VisualTuttiOrdiniServlet() {
        super();
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Map<Ordine, List<ProdottoOrdine>> ordiniEProdotti = ordineDAO.getAllOrdini();
