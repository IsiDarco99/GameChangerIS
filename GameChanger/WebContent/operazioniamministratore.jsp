...
<div class="container">
               <div class="blocco">
                  ...
                  <form action="Inserisci-Prodotto" method="post" onsubmit="return validateForm()">
                  <p>Categoria:<br> <select name="categoria" >
                    ...
                    <option value="computer">Computer</option>
                       ...
                       <p>Nome:<br> <input type="text" name="nomeprodotto" required onblur="validateNome()"></p>
                       <p id="errorNome" style="color: red;"></p>    
                        <p>Prezzo:<br> <input type="text" name="prezzoprodotto" required onblur="validatePrezzo()"></p>
                         <p id="errorPrezzo" style="color: red;"></p>                      
                         <p>Marca:<br> <input type="text" name="marcaprodotto" required onblur="validateMarca()"></p>
                         <p id="errorMarca" style="color: red;"></p>
                          <p>Data di uscita:<br> <input type="text" name="data_usc" required onblur="validateData()"></p>
                          <p id="errorData" style="color: red;"></p>
                           <p>Descrizione:<br> <textarea name="descrizioneprodotto" rows="10" cols="50" required onblur="validateDescr()"></textarea></p>
         ...
         case "elimina":
        	 ...
        	 <div class="container">
        	                <div class="blocco">
        	                   ...
        	                   <h2><strong>Elimina prodotto</strong></h2>
        	                   <form action="elimina-prodotto" method="post" onsubmit="return validateFormGen()">
        	                    <p>Codice del prodotto:</p><br> <input type="text" name="nomeprodotto">                                       
