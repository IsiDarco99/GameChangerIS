...
<%@ page import="cn.gamechanger.bean.User" %>
<%@ page import="cn.gamechanger.bean.Amministratore" %>
<%@ page import="cn.gamechanger.servlet.RecuperaProfiloServlet" %>
        	 ...
        	 %>
        	             <div class="container">
        	                ...
        	                <form action="modifica-dati" method="post" onsubmit="return validateIndirizzo()">
        	                   ...
        	                   <p>Nuova citt�: <input type="text" name="nuovaCitta"></p>
