...
<%
    ...
    if (categoria == null || (!categoria.equals("allProdotti") &&
                              !categoria.equals("videogiochi") &&
                              !categoria.equals("accessori") &&
                              !categoria.equals("computer") &&
                              !categoria.equals("console"))) {
                ...
                <div class="col-2">
                    <div class="categoria">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" id="ricerca-item" placeholder="Cerca" aria-label="Cerca" aria-describedby="button-addon2" onkeyup="ricerca()" value="<%= ricerca %>">
                        </div>
                        <div class="filtri">
