...
<%
    ...
    if (categoria == null) {
        ...
        categoria = categoria.replaceAll("[^a-zA-Z]", ""); // Filtra solo lettere
    }
                ...
                <div class="col-2">
                    ...
                    <div class="categoria">
                        ...
                        <div class="input-group ">
                            <input type="text" class="form-control" id="ricerca-item" iplaceholder="Recipient's username"
                                aria-label="Recipient's username" aria-describedby="button-addon2" onkeyup="ricerca()">
